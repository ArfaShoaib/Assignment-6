...
const Hero = () => {
  return (
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className=" flex flex-col md:flex-row items-center justify-center gap-8 mb-5 mt-12 md:mt-0 py-12 md:py-24 xl:ml-40">
        {/* Left Text Content */}
        ...
        {/* Right Image Content */}
        <div className="w-full flex justify-center xs:w-full sm:w-3/4 md:w-1/2 md:justify-end md:-ml-20 lg:w-[600px]">
